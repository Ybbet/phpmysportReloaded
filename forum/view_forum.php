...
if (($forum['forum_status'] == 2 AND (!isset($_SESSION['session_status']) OR !in_array($_SESSION['session_status'], array(
				'3',
				'4'
			)))) OR ($forum['forum_status'] == 1 AND MEMBER != 1)
) {
	...
	*/
	...
	if (isset($_GET['v2']) AND $_GET['v2'] != "") /* liste des messages du topic */ {
		if (preg_match("/page/", $_GET['v2'])) // il s'agit d'une page de la liste de topics
		{
