...
$default_pages = array(
	...
	array(
		'level' => 'parent',
		'title' => $lang['general']['news'],
		'url' => 'index.php?r=' . $lang['general']['idurl_news'] . '&v1=news_list',
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['information'],
		'url' => 'index.php?r=' . $lang['general']['idurl_information'],
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['team_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_team'] . '&v1=team_list',
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['member_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_member'] . '&v1=member_list',
		'class' => ''
	),
	array(
		'level' => 'child',
	...
	array(
		'level' => 'child',
		'title' => $lang['general']['player_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_team'] . '&v1=player_list',
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['manager_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_member'] . '&v1=manager_list',
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['coach_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_team'] . '&v1=coach_list',
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['referee_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_member'] . '&v1=referee_list',
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['match_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_match'],
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['match_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_match'] . '&v1=match_list',
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['standings'],
		'url' => 'index.php?r=' . $lang['general']['idurl_match'] . '&v1=standings',
		'class' => ''
	),
	array(
		'level' => 'child',
		'title' => $lang['general']['stats_player'],
		'url' => 'index.php?r=' . $lang['general']['idurl_match'] . '&v1=stats_player',
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['competition_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_competition'] . '&v1=competition_list',
		'class' => ''
	),
...
//array('order'=>'8.0','title'=>$lang['general']['search_member'],'url'=>'index.php?r='.$lang['general']['idurl_member'].'&v1=search_member','class'=>''),
	array(
		'level' => 'parent',
		'title' => $lang['general']['club_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_club'],
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['field_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_field'],
		'class' => ''
	),
	array(
		'level' => 'parent',
		'title' => $lang['general']['forum_list'],
		'url' => 'index.php?r=' . $lang['general']['idurl_forum'],
		'class' => ''
	)
);
		...
		foreach ($_POST['level'] AS $id => $value) {
			if ($_POST['level'][$id] != '') {
				...
				$line = array(
					$_POST['level'][$id],
					$_POST['title'][$id],
					preg_replace(',' . ROOT_URL . '/,', '', $_POST['url'][$id]),
					$_POST['class'][$id],
					$_POST['target'][$id]
				);
				fputcsv($fp, $line, ";");
...
if ($page['show_form']) {
	...
	if (CLUB != 0) {
		...
		for ($i = 0; $i < $nb_ligne; $i++) {
			...
			if (in_array(preg_replace("," . ROOT_URL . "/,", "", $page['team'][$i]['link_view']), $url_list)) {
	...
	for ($i = 0; $i < $nb_ligne; $i++) {
		...
		if (in_array(preg_replace("," . ROOT_URL . "/,", "", $page['club'][$i]['link_view']), $url_list)) {
	...
	for ($i = 0; $i < $nb_ligne; $i++) {
		...
		if (in_array(preg_replace("," . ROOT_URL . "/,", "", $page['information'][$i]['link']), $url_list)) {
	...
	for ($i = 0; $i < $nb_ligne; $i++) {
		...
		if (in_array(preg_replace("," . ROOT_URL . "/,", "", $page['forum'][$i]['link_forum']), $url_list)) {
	...
	for ($i = 0; $i < $nb_ligne; $i++) {
		...
		if (in_array(preg_replace("," . ROOT_URL . "/,", "", $page['competition'][$i]['link_view']), $url_list)) {
	...
	if (isset($plugin)) {
		...
		foreach ($plugin AS $value) {
			if ($value['active']) { // only active plugin
				...
				# if already present in the menu, we dont display it	
				if (in_array(preg_replace("," . ROOT_URL . "/,", "", $value['link']), $url_list)) {
	...
	foreach ($website_menu AS $value) {
		...
		# external pages
		if (!preg_match("," . ROOT_URL . ",", $value['url']) AND preg_match(',http,', $value['url'])) {
			$value['external'] = '1';
		} else {
			$value['external'] = '';
		}
